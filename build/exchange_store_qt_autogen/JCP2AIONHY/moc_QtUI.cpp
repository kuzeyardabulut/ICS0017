/****************************************************************************
** Meta object code from reading C++ file 'QtUI.hpp'
**
...
#error "The header file 'QtUI.hpp' doesn't include <QObject>."
...
template <> constexpr inline auto QtUI::qt_create_metaobjectdata<qt_meta_tag_ZN4QtUIE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        // Slot 'onExecuteExchange'
        QtMocHelpers::SlotData<void()>(1, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'onListTransactions'
        QtMocHelpers::SlotData<void()>(3, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'onDailyReport'
        QtMocHelpers::SlotData<void()>(4, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'onMonthlyReport'
...
void QtUI::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->onExecuteExchange(); break;
        case 1: _t->onListTransactions(); break;
        case 2: _t->onDailyReport(); break;
        case 3: _t->onMonthlyReport(); break;
        default: ;
        }
    }
    (void)_a;
