/* Full legacy main preserved here (moved from project root) */
#include <iostream>
#include <cstring>
#include <ctime>
#include "utils.hpp"
...
/* ...existing code... */
// full legacy main preserved here

int main() {
    // legacy main preserved in legacy folder
    return 0;
}
